...
export function MobileGate({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      {/* Show warning only on screens < 768px (md breakpoint) */}
      <div className="md:hidden fixed inset-0 z-[999] bg-[var(--color-bg,var(--color-background))] flex flex-col items-center justify-center p-8 text-center">
